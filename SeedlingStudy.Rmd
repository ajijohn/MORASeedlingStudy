...
photosynq %>%
  ...
  labs(x="Species",y="PSII Efficiency") + theme_minimal(base_size = 12) 
ggsave(filename = "figs/Rev1-Species-comparisons-by-elevation-Phi2.png",dpi = 300, width = 4, height = 4, units = "in")
...
photosynq %>%
  ...
  labs(x="",y="PSII Efficiency") + theme_minimal(base_size = 12) 
ggsave(filename = "figs/Rev1-Species-comparisons-by-canopy-Phi2.png",dpi = 300, width = 4, height = 4, units = "in")
...
photosynq %>%
  ...
  labs(x="Species",y="Non-photochemical Quenching") + theme_minimal(base_size = 12) 
ggsave(filename = "figs/Rev1-Species-comparisons-by-elevation-NPQt.png",dpi = 300, width = 4, height = 4, units = "in")
...
photosynq %>%
  ...
  labs(x="",y="Non-photochemical Quenching") + theme_minimal(base_size = 12) 
ggsave(filename = "figs/Rev1-Species-comparisons-by-canopy-NPQt.png",dpi = 300, width = 4, height = 4, units = "in")
